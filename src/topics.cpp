...
// subscriber that fills the CommBuffer cb_satellite_mode with values from topic topic_satellite_mode
Subscriber sub_satellite_mode(topic_satellite_mode, cb_satellite_mode_receiver_thread);
