...
public:
	...
	uint16_t begin(uint8_t agAddress = LSM9DS1_AG_ADDR(1), uint8_t mAddress = LSM9DS1_M_ADDR(1)); //By default use the default I2C addres, and use Wire port
	uint16_t beginSPI();
...
protected:	
	...
	void SPIwriteByte(HAL_GPIO* csPin, uint8_t subAddress, uint8_t data);
	...
	uint8_t SPIreadByte(HAL_GPIO* csPin, uint8_t subAddress);
	...
	uint8_t SPIreadBytes(HAL_GPIO* csPin, uint8_t subAddress,
